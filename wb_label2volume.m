function [status,cmdout] = wb_label2volume(wb_cfg, label_in, surf_file, volume_space, volume_out)
...
if nargin==0
    [wb_cfg, label_in, surf_file, volume_space, volume_out] = wb_label2volume_test;
end
